...
{{--
    .map-frame/.map-frame-inner (see app.css) scale this fixed-pixel thumbnail
    down to fit a narrower parent — e.g. a location card on a phone screen —
    instead of forcing that parent wider than the viewport.
--}}
<a
    href="{{ $mapUrl }}"
    target="_blank"
